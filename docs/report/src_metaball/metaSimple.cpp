...
ApplicationMain::ApplicationMain(int argc,char *argv[])
{
    ...
    int centerZ = wid/2 ;
    int len = 50;
    line.vtx1.push_back(32);line.vtx1.push_back(32);line.vtx1.push_back(32);
    line.vtx2.push_back(62);line.vtx2.push_back(62);line.vtx2.push_back(62);
